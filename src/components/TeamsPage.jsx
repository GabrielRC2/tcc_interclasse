                ...
                {selectedTeam.players && selectedTeam.players.length > 0 ? (
                  <div className="space-y-2 max-h-60 overflow-y-auto">
                    {selectedTeam.players.map((player, index) => {
                      const isLastOrSecondLast = index >= selectedTeam.players.length - 2;
                      return (
                        <div key={player.id} className="flex items-center gap-3 p-2 bg-gray-50 dark:bg-gray-700 rounded relative">
                          ...
                          <div className="relative">
                            ...
                            {openDropdownId === player.id && (
                              <div className={`absolute right-0 ${isLastOrSecondLast ? 'bottom-8' : 'top-8'} bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-xl z-50 min-w-[140px] overflow-hidden`}>
                                <button
                                  onClick={() => {
                                    setEditingPlayer({
                                      id: player.id,
