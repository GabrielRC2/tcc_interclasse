...
**Cenários Críticos:**
- [ ] **CT001** - Criar novo torneio "Meio do Ano" com modalidades automáticas
- [ ] **CT002** - Criar novo torneio "Fim de Ano" com modalidades automáticas  
- [ ] **CT003** - Editar torneio existente (datas, local, modalidades)
- [ ] **CT004** - Excluir torneio sem partidas cadastradas
- [ ] **CT005** - Tentar excluir torneio com partidas (deve impedir)
- [ ] **CT006** - Validação de campos obrigatórios
- [ ] **CT007** - Validação de datas (início < fim)
